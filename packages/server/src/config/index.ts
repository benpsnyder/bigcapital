...
Bun.env.APP_ROOT_DIR = path.join(__dirname, '..');
Bun.env.APP_RESOURCES_DIR = path.join(Bun.env.APP_ROOT_DIR, 'resources');
Bun.env.APP_LOCALES_DIR = path.join(Bun.env.APP_RESOURCES_DIR, 'locales');
Bun.env.APP_VIEWS_DIR = path.join(Bun.env.APP_ROOT_DIR, 'views');
Bun.env.APP_STORAGE_DIR = path.join(Bun.env.APP_ROOT_DIR, 'storage');

console.log('APP_ROOT_DIR:', Bun.env.APP_ROOT_DIR);
console.log('APP_RESOURCES_DIR:', Bun.env.APP_RESOURCES_DIR);
console.log('APP_LOCALES_DIR:', Bun.env.APP_LOCALES_DIR);
console.log('APP_VIEWS_DIR:', Bun.env.APP_VIEWS_DIR);
console.log('APP_STORAGE_DIR:', Bun.env.APP_STORAGE_DIR);
